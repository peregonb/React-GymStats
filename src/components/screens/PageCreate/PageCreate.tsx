...
import {HashExercises} from "./HashExercises";
        ...
        <div className={'content-create'}>
            <HashRouter>
                <div className={'tabs content-create-tabs'}>
                    <NavLink to='/trainings' activeClassName={'active'} className={'tabs-item'}>Тренировка</NavLink>
                    <NavLink to='/templates' activeClassName={'active'} className={'tabs-item'}>Шаблон</NavLink>
                    <NavLink to='/exercises' activeClassName={'active'} className={'tabs-item'}>Упражнения</NavLink>
                </div>
